...
console.log('Tamaño del array de meses: ' + size_meses)
console.log('Tamaño del array de fechas: ' + size_fechas)
console.log('Tamaño del array de dias: ' + size_dias)

// Ahora rellena el array "dias" con los dias de las semana, lunes, martes, mier...
